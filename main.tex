...
whows 12 SPARQL-driven panels on the Scholia event
aspect~\cite{Nielsen2017}, rendered identically by the legacy Blazegraph
endpoint at
...
\toprule
\# & Panel (template id) & What the panel answers about the event \\
\midrule
...
3  & \texttt{co-authors}                & Co-author graph of people involved  \\
4  & \texttt{sponsors}                  & Sponsors of the event \\
5  & \texttt{timeline}                  & Timeline of related events \\
