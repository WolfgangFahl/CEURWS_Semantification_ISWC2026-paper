...
The pyCEURmake ~\cite{pyCEURmake} tool was created to parse the main HTML index as well as the individual proceedings HTML pages. The results have been cached in JSON and SQLite storage for quick access. Location entries have been consolidated using the ~\cite{geograpy3} library. Author, Editor and Paper details have been aligned with the DBLP SPARQL endpoint.
