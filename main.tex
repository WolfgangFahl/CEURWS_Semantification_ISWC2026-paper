...
CEUR-WS metadata is contributed to Wikidata. Figure~\ref{fig:wikicite_proceedings_editors}
...
for the Scholia panels discussed in Section~\ref{sec:wikicite} below.
...
\begin{figure}[t]
    ...
    CEUR-WS proceedings items (\wdq{Q1143604}{Q1143604}) on Wikidata.}
