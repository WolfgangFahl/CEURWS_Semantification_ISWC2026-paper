...
ceur-spt ~\cite{ceur-spt} is the prototype for showing the benefits of semantification by improved linking and navigation capabilities compared to the current static CEUR-WS HTML page.
...
by DBLP, the German National Library (GND), TIB, Wikidata/WikiCite and
...
coverage and consistency. The public synchronization dashboard at
\url{https://cvb.wikidata.dbis.rwth-aachen.de/wikidatasync} is an
...
CEUR-WS editors, DBLP curators, GND and TIB librarians, Wikidata and
...
Library catalogues such as GND historically optimize for physical
